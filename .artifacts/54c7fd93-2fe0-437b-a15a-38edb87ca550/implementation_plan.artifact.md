...
- Remove non-MVP tabs: `dashboard`, `batch`, `settings`, `library` (as a separate tab, merge into a simple history view if needed, but primary focus is the workflow).
- Simplify Header to only show essential navigation.
