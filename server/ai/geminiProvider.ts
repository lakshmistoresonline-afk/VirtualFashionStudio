          ...
          scriptSegments: parsed.scriptSegments || [
            {
              ...
              language: 'ml-IN',
              duration: 3.5,
              type: (input.presentationMode === 'voice_over' ? 'VOICE_OVER' : 'TALKING_MODEL') as any,
            ...
            },
            {
              ...
              language: 'ml-IN',
              duration: 4.5,
              type: (input.presentationMode === 'talking_model' ? 'TALKING_MODEL' : 'VOICE_OVER') as any,
            ...
            },
            {
              ...
              language: 'ml-IN',
              duration: 3.5,
              type: (input.presentationMode === 'voice_over' ? 'CTA' : 'TALKING_MODEL') as any,
              speaker: input.presentationMode === 'voice_over' ? 'Narrator Voiceover' : `AI Model (${input.modelProfile.name.split(' ')[0]})`,
              shotId: 'shot_4',
              shotIndex: 3,
              startTime: 11.5,
